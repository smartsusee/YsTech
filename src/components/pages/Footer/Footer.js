      ...
      <div className="mx-auto w-full max-w-7xl px-8">
        <div className="mx-auto grid w-full grid-cols-1 gap-8 py-12 md:grid-cols-2 lg:grid-cols-4">
          {SITEMAP.map(({ title, links }, key) => (
            <div key={key} className="w-full">
              <Typography
                variant="small"
                className="mb-4 font-bold uppercase opacity-80 text-white"
              >
                {title}
              </Typography>
              <ul className="space-y-1">
                {links.map((link, key) => (
                  <Typography key={key} as="li" className="font-normal text-gray-300">
                    <a
                      href="#"
                      className="inline-block py-1 pr-2 transition-transform hover:scale-105 hover:text-white"
                    >
                      {link}
                    </a>
                  </Typography>
        ...
        <div className="flex w-full flex-col items-center justify-center border-t border-gray-800 py-4 md:flex-row md:justify-between">
          ...
          <div className="flex gap-4 text-gray-400 sm:justify-center">
            <Typography as="a" href="#" className="opacity-80 transition-opacity hover:opacity-100 hover:text-white">
